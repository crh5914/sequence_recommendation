...
def get_model(num_users, num_items, mf_dim=10, layers=[10], reg_layers=[0], reg_mf=0):
    ...
    MF_Embedding_User = Embedding(input_dim = num_users, output_dim = mf_dim, name = 'mf_embedding_user',
                                  embeddings_initializer = initializers.RandomNormal(mean=0.0, stddev=0.01, seed=None), embeddings_regularizer = l2(reg_mf), input_length=1)
...
if __name__ == '__main__':
    ...
    model_out_file = 'result/%s_neu_mf_%d_%s_%d.h5' %(args.dataset, mf_dim, args.layers, time())
