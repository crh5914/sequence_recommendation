...
def parse_args():
    parser = argparse.ArgumentParser(description='run lrml')
    ...
    parser.add_argument('--batch_size', type=int, default=256,
                        help='Batch size.')
    parser.add_argument('--num_men', type=int, default='20',
                        help="number of memeroy slots")
    parser.add_argument('--std', type=float, default='0.01',
                        help="standard variance to initialize weight")
    parser.add_argument('--rnn_type', nargs='?', default=['PAIR'],
